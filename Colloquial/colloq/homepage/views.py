...
def test(request):
	classifier = load_model('/home/saptarshi/Desktop/Hand Gesture Recognition System/colloq/homepage/Trained_model.h5')
#classifier.evaluate()

#Prediction of single image

	#img_name = input('Enter Image Name:')
	image_path = '//home/saptarshi/Desktop/Hand Gesture Recognition System/colloq/'+request.POST['url']
